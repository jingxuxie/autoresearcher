JSON
{
  ...
  "next_experiment": {
    "experiment_id": "0004_repair_nondegenerate_sampled_vs_soft",
    ...
    "required_outputs": [
      ...
      "research/reward_to_gcrl/artifacts/0004/environment_and_reward_audit.json",
...
This is a pivot in emphasis, not a pivot away from the project: first repair the objective/normalization ambiguity, then decide whether RiverSwim or auxiliary-goal tests are justified.