...
This is a guarded continue: the repo summary says 0010 should be a small posterior-transitive tabular ablation, not larger compute, and the 0009 review’s caveats make equivalence-to-model-DP a negative result rather than a win. 
