...
```json
{
  ...
  "last_decision": "pivot",
  "last_failure": null,
  "last_pro_review_iteration": 12,
  "last_pro_review_path": "research/sto_trl/decisions/0013_pro_decision.json",
  "last_summary_iteration": 12,
  "last_summary_path": "research/sto_trl/progress/0012_pre_pro_local_pivot_summary.md",
  ...
  "notes": [
    ...
    "2026-06-14T04:02:40+00:00: Pro decision saved for checkpoint local_stop (research/sto_trl/decisions/0012_pro_decision.json)",
    "2026-06-14T04:03:00+00:00: applied Pro decision stop from research/sto_trl/decisions/0012_pro_decision.json",
    "2026-06-14T05:59:47+00:00: Pro checkpoint blocked (browser_bridge_unavailable); packet research/sto_trl/pro_packets/0012_review2_PRO_REVIEW_PACKET.md",
    "2026-06-14T06:02:00+00:00: Pro checkpoint blocked (browser_bridge_unavailable); packet research/sto_trl/pro_packets/0012_review3_PRO_REVIEW_PACKET.md",
    "2026-06-14T06:08:11+00:00: Pro decision saved for checkpoint human_requested_pivot (research/sto_trl/decisions/0012_review4_pro_decision.json)",
    "2026-06-14T06:08:42+00:00: applied Pro decision pivot from research/sto_trl/decisions/0012_review4_pro_decision.json",
    "2026-06-14T06:22:59+00:00: Pro decision saved for checkpoint local_pivot (research/sto_trl/decisions/0013_pro_decision.json)",
    "2026-06-14T06:23:01+00:00: applied Pro decision pivot from research/sto_trl/decisions/0013_pro_decision.json"
  ],
...
[
  ...
  },
  {
    ...
    "decision": "stop",
    "hypothesis": "In a latent tabular MDP with two or more hidden states sharing the same observation, observation-only empirical model DP and observation-only TRL-log will be miscalibrated, while history-keyed MC+TRL-log will improve held-out long-horizon v...",
    "interpretation": "Observation-only model DP and TRL-log fail on the aliased hub because good and bad hidden states share observation 'hub'.",
    "iteration": "0012",
    "known_failures": [
    ...
    "review_reasons": [
      ...
      "The comparison is mostly fair: observation-only model DP/TRL-log, history-keyed MC-only/TRL-log/MC+TRL-log, history-model DP, and latent-oracle evaluation are all evaluated on the...",
      "... 4 more; inspect full file"
    ],
    "risk_flags": [
  ...
  },
  {
    ...
    "hypothesis": "Across a small randomized suite of aliased tabular POMDPs with varying cue reliability and history sufficiency, observation-only methods will fail when observations alias latent states, bounded-history methods will improve when history is s...",
    "interpretation": "Observation-only methods fail under aliasing, and bounded history improves strongly when cues are sufficient.",
    "iteration": "0013",
    "known_failures": [
    ...
    "metrics": {
      ...
      "_keys": [
        "cue_regimes_present",
        "cue_sufficient_history_mc_plus_improvement_fraction_vs_mc_only",
        "cue_sufficient_summary",
        "leakage_free_training_keys",
        "method_summary",
        "model_dp_explains_all_history_mc_plus_gains",
        "num_cases",
        "num_metric_rows",
        "observation_aliasing_failure"
      ],
      "scalars": {
    ...
    "review": "weak_pass",
    "review_reasons": [
      "Required outputs were produced: 0013_result.json, 0013_summary.md, and a populated research/sto_trl/artifacts/0013 directory with raw metrics, summaries, coverage, offline datasets...",
    ...
    "risk_flags": [
      ...
      "The positive cue-sufficient cases rely on observed cue tokens that disambiguate context; this is allowed by the plan but mainly demonstrates representation sufficiency rather than...",
...
## 0012_review4_pro_decision.json
...
- `research/sto_trl/progress/0011_pre_pro_local_stop_summary.md`
- `research/sto_trl/progress/0012_pre_pro_local_pivot_summary.md`
...
- `research/sto_trl/plans/0012_plan.md`
- `research/sto_trl/plans/0013_plan.md`
...
- `research/sto_trl/decisions/0012_review4_pro_decision.md`
- `research/sto_trl/decisions/0013_pro_decision.md`
