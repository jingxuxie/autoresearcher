...
```json
{
  ...
  "evidence_checked": [
    ...
    "research/sto_trl/artifacts/0004/transition_tables.json",
    "research/sto_trl/artifacts/0004/value_tables.json",
    "python scripts/validate_artifacts.py --repo-root . --json research/sto_trl/results/0004_result.json --schema schemas/result.schema.json --check-result-artifacts",
    "git status --short"
  ],
  "experiment_id": "0004",
  "reasons": [
...
Use `0005` as the exact `next_experiment.experiment_id` if you choose continue.
